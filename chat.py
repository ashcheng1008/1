if lineMessage[0:3]==“看醫生”:
  ...
  if  lineMes[4:-1]==“”:
      ...
      address=lineMes[4:-1]
  addurl=‘https://maps.googleapls.com/maps/api/getcode/json?key={}&address={}&sensor=false’.format(GOOGLE_API_KEY,address)
...
medsearch=‘https://maps.googleapls.com/maps/api/getcode/json?key={}&address={}&sensor=false’.format(GOOGLE_API_KEY,lat,lng)
...
if clinic.get(“photos”) is None:
  ...
  thumbnail_image_url=“https://maps.googleapls.com/maps/api/place/photo?key={}&photoreference={}&maxwidth={}”.format(GOOGLE_API_KEY,photo_reference,photo_width)
